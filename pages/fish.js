...
export default function Fish(){
    ...
    let data = useSelector((state):any => data);
    let score = useSelector((state):any => score);
    let time = useSelector((state):any => time);
    let randTime = useSelector((state):any => randTime);
    let hurricane = useSelector((state):any => hurricane);
